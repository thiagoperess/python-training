...
number = int(input('Digite um número menor que 1000: '))
unity = number // 1 % 10
ten = number // 10 % 10 
hundred = number // 100 % 10
thousand = number // 1000 % 10

print(f'Analisando o número {number} temos:')
print(f'{unity} unidades, {ten} dezenas, {hundred} centenas e {thousand} milhares.')
